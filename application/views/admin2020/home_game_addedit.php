                                        ...
                                        <form class="needs-validation"  enctype="multipart/form-data"  id="validate" novalidate="" method="POST" action="<?php if ($Action == $this->lang->line('text_action_add')) { ?><?php echo base_url() . $this->path_to_view_admin ?>home_game/insert<?php } elseif ($Action == $this->lang->line('text_action_edit')) { ?><?php echo base_url() . $this->path_to_view_admin ?>home_game/edit<?php } ?>">                                            
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <p><b><?php echo $this->lang->line('text_image_note'); ?> : </b> <?php echo "Upload 500x500 size of image for better view in app."; ?></p>    
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <p><b><?php echo $this->lang->line('text_image_note'); ?> : </b> <?php echo "Upload 200x200 size of image for better view in app."; ?></p>                                                        
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="coming_soon"><?php echo 'coming soon'; ?><span class="required" aria-required="true"> * </span></label>
                                                    <div class="form-group col-md-12">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input id="coming_soon_yes" name="coming_soon" type="radio" class="custom-control-input" value="1" <?php
                                                            if (isset($coming_soon) && $coming_soon == '1') {
                                                                echo 'checked';
                                                            } elseif (isset($game_detail['coming_soon']) && $game_detail['coming_soon'] == '1') {
                                                                echo 'checked';
                                                            }
                                                            ?> >&nbsp;
                                                            <label class="custom-control-label" for="coming_soon_yes"><?php echo "yes"; ?></label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input id="coming_soon_no" name="coming_soon" type="radio" class="custom-control-input" value="0" <?php
                                                            if (isset($coming_soon) && $coming_soon == '0') {
                                                                echo 'checked';
                                                            } elseif (isset($game_detail['coming_soon']) && $game_detail['coming_soon'] == '0') {
                                                                echo 'checked';
                                                            } elseif ($Action == $this->lang->line('text_action_add')) {
                                                                echo 'checked';
                                                            }
                                                            ?>>&nbsp;
                                                            <label class="custom-control-label" for="coming_soon_no"><?php echo "no"; ?></label>
                                                        </div>
                                                    </div>
                                                    <?php echo form_error('coming_soon', '<em style="color:red">', '</em>'); ?>
                                                </div>
                                            ...
                                            <div class="form-group text-center">
                                                ...
                                                <a class="btn btn-secondary" href="<?php echo base_url() . $this->path_to_view_admin; ?>home_game/" name="cancel"><?php echo $this->lang->line('text_btn_cancel'); ?></a>   
                                            </div>
                                        </form>
                                    </div>
                                </div>
