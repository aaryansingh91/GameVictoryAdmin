...
class FlattenExceptionTest extends TestCase
{
    ...
    public function testFlattenHttpException(\Exception $exception)
    {
        ...
        $this->assertInstanceOf($flattened->getType()->getName(), $exception, 'The class is set to the class of the original exception');
    }
    ...
    public function testPreviousError()
    {
        ...
        $this->assertEquals('Symfony\Component\Debug\Exception\FatalThrowableError', $flattened->getType()->getName(), 'The class is set to the class of the original exception');
    }
