...
class RegisterListenersPass implements CompilerPassInterface
{
        ...
        foreach ($container->findTaggedServiceIds($this->listenerTag, true) as $id => $events) {
            foreach ($events as $event) {
                ...
                if (!isset($event['method'])) {
                    ...
                    if (null !== ($class = $container->getDefinition($id)->getType()->getName()) && ($r = $container->getReflectionClass($class, false)) && !$r->hasMethod($event['method']) && $r->hasMethod('__invoke')) {
    ...
    {
        if (
            null === ($class = $container->getDefinition($id)->getType()->getName())
